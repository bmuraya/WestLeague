                            ...
                            <div class="login-form">
                                ...
                                <form method="POST" action="{{ route('login') }}" name="login-form" class="needs-validation"
                                    ...
                                    <div class="form-floating mb-3">
                                        <input class="form-control form-control_gray @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}"
                                        required autocomplete="email" autofocus>
                                    ...
                                    <div class="customer-option mt-4 text-center pb-4">
                                        <span class="text-secondary">No account yet?</span>  | 
                                        <a href="{{ route('register') }}" class="btn-text text-danger js-show-register">Create Account</a>  
